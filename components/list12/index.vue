<template>
  ...
  >
    ...
    <div class="main" :style="{width:width+'px'}">
      ...
      >
        <img :src="item.imgUrl"/>
        <div class="cont" :style="contMainStyle">
    ...
    computed:{
      ...
      btnStyle(){
        return {
          ...
          "fontSize" : this.info.btnFontSize+'px',
          "color" : this.info.btnFontColor,
          "height" : this.info.btnHeight+'px'
        }
      },
      contMainStyle(){
        return {
      ...
      contStyle(){
        return {
          "fontSize" : this.info.itemContFontSize ? this.info.itemContFontSize+'px' : '14px',
          "color" : this.info.itemContColor ? this.info.itemContColor : '#606060',
        }
      },
      //列表宽度
      listWidth(){
      ...
      myStyle(){
        return {
          ...
          "--btnHeight": this.info.btnHeight+'px',
          "--btnHeight2": '-'+this.info.btnHeight+'px',
        }
      },
    },
    async created() {
  ...
  .list {
    ...
    .main{
      ...
      .item{
        ...
        &:hover{
          img,.cont{
            transform: translateY(var(--btnHeight2));
          }
          .btn{
            display: block;
          }
